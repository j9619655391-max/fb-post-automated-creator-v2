...
from app.api.routes import content, users, audit_logs, auth_facebook, meta_pages, scheduled_posts, cron, vce, auth, media, ai, instagram, auth_linkedin, platforms, organizations, billing, admin_settings, generation, generation_plans, workspace_intelligence, brand_themes, remaining_roadmap
...
api_router.include_router(workspace_intelligence.router, prefix="/organizations", tags=["workspace-intelligence"])
api_router.include_router(brand_themes.router, prefix="/organizations", tags=["brand-themes"])
api_router.include_router(remaining_roadmap.router, prefix="/organizations", tags=["remaining-roadmap"])
